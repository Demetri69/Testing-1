const config = {
  ...
  */
  ...
  // 🔐 Passcode Page
  correctPasscode: "112230", // Change this to any 4-digit code (the passcode for access)
  ...
  trendingSearches: [
    "Why hate ko ni Alexis?", // Example trending search query
    "Love pa kaya ko ni Alexis Kylle?", // Another example query
    `Wil Alexis be my valentines?`, // A personalized trending search
  ],
  proTip: 'Pro tip: try searching "How long have we been together?" ;)', // Helpful tip for users

  // ⏳ Timer Page
  anniversaryDate: "2022-11-30", // 📅 Set your anniversary date here (used for the timer)
